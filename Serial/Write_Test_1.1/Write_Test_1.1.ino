...
void loop() 
{
  ...
  // (Reverser), Throttle, Auto Brake, Independent Brake, Bail Off, Top Rotary Switch, Bottom Rotary Switch.
  ...
  //Reverser, Throttle, (Auto Brake), Independent Brake, Bail Off, Top Rotary Switch, Bottom Rotary Switch.
  //val[2] = cycle;
  val[2] = analogRead(analogPin1);
  //val[2] = map(val[2], 0, 388, 1, 64);
  val[2] = map(val[2], 0, 1023, 0, 255);
  //val[2] = val[2] * 4;
  ...
  // Reverser, Throttle, Auto Brake, (Independent Brake), Bail Off, Top Rotary Switch, Bottom Rotary Switch.
  //val[3] = cycle;
  val[3] = analogRead(analogPin1);
  //val[3] = map(val[3], 0, 388, 1, 64);
  val[3] = map(val[3], 0, 1023, 0, 255);
  //val[3] = val[3] * 4;
  ...
  // Reverser, Throttle, Auto Brake, Independent Brake, (Bail Off), Top Rotary Switch, Bottom Rotary Switch.
  //val[4] = cycle;
  val[4] = analogRead(analogPin1);
  //val[4] = map(val[4], 0, 388, 1, 64);
  val[4] = map(val[4], 0, 1023, 0, 255);
  //val[4] = val[4] * 4;
  ...
  // Reverser, Throttle, Auto Brake, Independent Brake, Bail Off, (Top Rotary Switch), Bottom Rotary Switch.
  //val[5] = cycle;
  val[5] = analogRead(analogPin1);
  //val[5] = map(val[5], 0, 388, 1, 64);
  val[5] = map(val[5], 0, 1023, 0, 255);
  //val[5] = val[5] * 4;
  ...
  // Reverser, Throttle, Auto Brake, Independent Brake, Bail Off, Top Rotary Switch, (Bottom Rotary Switch).
  //val[6] = cycle;
  val[6] = analogRead(analogPin1);
  //val[6] = map(val[6], 0, 388, 1, 64);
  val[6] = map(val[6], 0, 1023, 0, 255);
  //val[6] = val[6] * 4;
